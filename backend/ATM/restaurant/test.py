...
class RestaurantTestCase(TestCase):
    def setUp(self):
        ...
        mock_time_A.save()
        mock_time_B = openTime(restaurant=mock_restaurant_B, condition='휴무', time='9:00')
        mock_time_B.save()
        #ThumbNail
        mock_ThumbNail_A = ThumbNail(restaurant=mock_restaurant_A, url='www.naver.com')
        mock_ThumbNail_A.save()

        mock_ThumbNail_B = ThumbNail(restaurant=mock_restaurant_B, url='www.naver.com')
        mock_ThumbNail_B.save()
        #keyword
        mock_keyword_A = keyword(restaurant=mock_restaurant_A, word='짠',weight=30)
        mock_keyword_A.save()
        mock_keyword_B = keyword(restaurant=mock_restaurant_B, word='짠',weight=30)
        mock_keyword_B.save()
